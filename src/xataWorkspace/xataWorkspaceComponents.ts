 ...
 * @version 1.0
 */
import type * as Fetcher from "./xataWorkspaceFetcher";
import {
  xataWorkspaceFetch,
  XataWorkspaceFetcherExtraProps,
} from "./xataWorkspaceFetcher";
import type * as Schemas from "./xataWorkspaceSchemas";
import type * as Responses from "./xataWorkspaceResponses";
 ...
 */
export const copyBranch = (variables: CopyBranchVariables) =>
  xataWorkspaceFetch<
    Schemas.BranchWithCopyID,
    CopyBranchError,
    CopyBranchRequestBody,
    {},
    {},
    CopyBranchPathParams
  >({ url: "/db/{dbBranchName}/copy", method: "post", ...variables });
...
export const queryMigrationRequests = (
  variables: QueryMigrationRequestsVariables
) =>
  xataWorkspaceFetch<
...
export const createMigrationRequest = (
  variables: CreateMigrationRequestVariables
) =>
  xataWorkspaceFetch<
...
export const getMigrationRequest = (variables: GetMigrationRequestVariables) =>
  xataWorkspaceFetch<
    ...
    GetMigrationRequestError,
    undefined,
    {},
    {},
    GetMigrationRequestPathParams
  >({
...
export const updateMigrationRequest = (
  variables: UpdateMigrationRequestVariables
) =>
  xataWorkspaceFetch<
    undefined,
...
export const listMigrationRequestsCommits = (
...
export const compareMigrationRequest = (
  variables: CompareMigrationRequestVariables
) =>
  xataWorkspaceFetch<
...
export const getMigrationRequestIsMerged = (
  variables: GetMigrationRequestIsMergedVariables
) =>
  xataWorkspaceFetch<
...
export const mergeMigrationRequest = (
  variables: MergeMigrationRequestVariables
) =>
  xataWorkspaceFetch<
    Schemas.BranchOp,
...
export const getBranchSchemaHistory = (
...
export const compareBranchWithUserSchema = (
...
export const compareBranchSchemas = (
  variables: CompareBranchSchemasVariables
) =>
  xataWorkspaceFetch<
    Responses.SchemaCompareResponse,
...
export const previewBranchSchemaEdit = (
  variables: PreviewBranchSchemaEditVariables
) =>
  xataWorkspaceFetch<
...
export const applyBranchSchemaEdit = (
  variables: ApplyBranchSchemaEditVariables
) =>
  xataWorkspaceFetch<
    Responses.SchemaUpdateResponse,
 ...
 */
export const pushBranchMigrations = (
  variables: PushBranchMigrationsVariables
) =>
  xataWorkspaceFetch<
    Responses.SchemaUpdateResponse,
  ...
  >({ url: "/db/{dbBranchName}/schema/push", method: "post", ...variables });
...
export const branchTransaction = (variables: BranchTransactionVariables) =>
  xataWorkspaceFetch<
  ...
  >({ url: "/db/{dbBranchName}/transaction", method: "post", ...variables });
 ...
 */
export const getFileItem = (variables: GetFileItemVariables) =>
  xataWorkspaceFetch<
    string,
    GetFileItemError,
    undefined,
 ...
 */
export const putFileItem = (variables: PutFileItemVariables) =>
  xataWorkspaceFetch<
    Responses.PutFileResponse,
    PutFileItemError,
    string,
    {},
    {},
    PutFileItemPathParams
  >({
    url: "/db/{dbBranchName}/tables/{tableName}/data/{recordId}/column/{columnName}/file/{fileId}",
    method: "put",
    ...variables,
 ...
 */
export const deleteFileItem = (variables: DeleteFileItemVariables) =>
  xataWorkspaceFetch<
    Responses.PutFileResponse,
    DeleteFileItemError,
    undefined,
 ...
 */
export const getFile = (variables: GetFileVariables) =>
  xataWorkspaceFetch<
    string,
    GetFileError,
    undefined,
 ...
 */
export const putFile = (variables: PutFileVariables) =>
  xataWorkspaceFetch<
    Responses.PutFileResponse,
    PutFileError,
    string,
 ...
 */
export const sqlQuery = (variables: SqlQueryVariables) =>
  xataWorkspaceFetch<
    ...
    {},
    SqlQueryPathParams
  >({ url: "/db/{dbBranchName}/sql", method: "post", ...variables });
 ...
 */
export const vectorSearchTable = (variables: VectorSearchTableVariables) =>
  xataWorkspaceFetch<
    Responses.SearchResponse,
 ...
 */
export const askTable = (variables: AskTableVariables) =>
  xataWorkspaceFetch<
    AskTableResponse,
    AskTableError,
    AskTableRequestBody,
